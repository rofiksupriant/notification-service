...
class TemplateControllerTest {
    ...
    void shouldFetchTemplateSuccessfully() throws Exception {
        // Given
        when(templateManagementAdapter.getTemplate("welcome", "en", Channel.EMAIL)).thenReturn(templateResponse);
        ...
        verify(templateManagementAdapter).getTemplate("welcome", "en", Channel.EMAIL);
    }
    ...
    void shouldReturn404WhenTemplateNotFound() throws Exception {
        // Given
        when(templateManagementAdapter.getTemplate("missing", "en", Channel.EMAIL))
    ...
    void shouldUpdateTemplateWithValidApiKey() throws Exception {
        // Given
        when(apiKeyValidator.validateApiKey(VALID_API_KEY)).thenReturn(true);
        when(templateManagementAdapter.updateTemplate("welcome", "en", Channel.EMAIL, updateRequest))
        ...
        verify(apiKeyValidator).validateApiKey(VALID_API_KEY);
        verify(templateManagementAdapter).updateTemplate("welcome", "en", Channel.EMAIL, updateRequest);
    }
    ...
    void shouldRejectUpdateTemplateWithInvalidApiKey() throws Exception {
        ...
        verify(templateManagementAdapter, never()).updateTemplate(anyString(), anyString(), any(Channel.class), any());
    }
    ...
    void shouldDeleteTemplateWithValidApiKey() throws Exception {
        // Given
        when(apiKeyValidator.validateApiKey(VALID_API_KEY)).thenReturn(true);
        doNothing().when(templateManagementAdapter).deleteTemplate("welcome", "en", Channel.EMAIL);
        ...
        verify(apiKeyValidator).validateApiKey(VALID_API_KEY);
        verify(templateManagementAdapter).deleteTemplate("welcome", "en", Channel.EMAIL);
    }
    ...
    void shouldRejectDeleteTemplateWithInvalidApiKey() throws Exception {
        ...
        verify(templateManagementAdapter, never()).deleteTemplate(anyString(), anyString(), any(Channel.class));
    }
